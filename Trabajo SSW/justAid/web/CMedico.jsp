<%-- 
    Document   : CMedico
    Created on : 24-may-2018, 16:02:43
    Author     : Enrique
--%>
            ...
            <div id="contenedor" class="contenedorclearfix">
                <form method = "post" action="Exit">
                    <div class="div-migas">
                        ...
                        <strong class = "actual"> > Atención medica</strong>
                ...
                <form method="post" action="GeneraAtencion">
                    <div class ="cuerpo">
                        <div class ="imagenprof"> 
                            <img class="imagenpro" src="imagenes/medico.jpg"  alt="logo_inicio" >
                        </div>
                        <div class= "eleccion">
                        ...
                        <div class="peticion">
                            <p>Introduzca precedentes para la consulta</p>
