            ...
            <div id="contenedor" class="contenedorclearfix">
                <form method = "post" action="Exit">
                    <div class="div-migas">
                        ...
                        <strong class = "actual"> > Comida a domicilio</strong>
                ...
                <form name="peticion" method="post" action="GeneraAtencion">
                    <div class ="cuerpo">
                        <div class ="imagenprof"> 
                            <img class="imagenpro" src="imagenes/comida-a-domicilio.jpg"  alt="logo_inicio" >
                        </div>
                        <div class= "eleccion">
